...
import { testDocuments, getTestDocument, getTestUrl, getTestTextSnippet, testUrls, testTextSnippets } from '@/lib/test-documents';
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="grid gap-2 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-gray-600">{testUrls.highRisk[0]}</span>
                    </div>
                    <div>
                      <span className="font-medium text-yellow-600">Medium Risk:</span>
                      <span className="ml-2 text-gray-600">{testUrls.mediumRisk[0]}</span>
                    </div>
                    <div>
                      <span className="font-medium text-green-600">Low Risk:</span>
                      <span className="ml-2 text-gray-600">{testUrls.lowRisk[0]}</span>
                    </div>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="text">
                ...
                <div className="mt-4 space-y-3">
                  <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                    ...
                    <p className="text-xs text-red-800">{testTextSnippets.highRisk.substring(0, 100)}...</p>
                  </div>
                  <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    <h5 className="font-semibold text-yellow-900 mb-1">Medium Risk Text Sample:</h5>
                    <p className="text-xs text-yellow-800">{testTextSnippets.mediumRisk.substring(0, 100)}...</p>
                  </div>
                  <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                    <h5 className="font-semibold text-green-900 mb-1">Low Risk Text Sample:</h5>
                    <p className="text-xs text-green-800">{testTextSnippets.lowRisk.substring(0, 100)}...</p>
                  </div>
                </div>
              </TabsContent>
            </Tabs>
                ...
                <CardContent>
                  <div className="mb-4">
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      {testUrls.highRisk.slice(0, 3).map((url, idx) => (
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg max-h-64 overflow-y-auto">
                    ...
                    <pre className="text-sm text-gray-700 whitespace-pre-wrap">
                      {testDocuments.highRisk.substring(0, 500)}...
                    </pre>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="mb-4">
                    <h5 className="font-semibold mb-2">Sample URLs:</h5>
                    <div className="text-sm text-gray-600 space-y-1">
                      {testUrls.mediumRisk.slice(0, 3).map((url, idx) => (
                        <div key={idx} className="flex items-center">
                          <Link className="h-3 w-3 mr-2" />
                          {url}
                        </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg max-h-64 overflow-y-auto">
                    <h5 className="font-semibold mb-2">Document Sample:</h5>
                    <pre className="text-sm text-gray-700 whitespace-pre-wrap">
                      {testDocuments.mediumRisk.substring(0, 500)}...
                    </pre>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="mb-4">
                    <h5 className="font-semibold mb-2">Sample URLs:</h5>
                    <div className="text-sm text-gray-600 space-y-1">
                      {testUrls.lowRisk.slice(0, 3).map((url, idx) => (
                        <div key={idx} className="flex items-center">
                          <Link className="h-3 w-3 mr-2" />
                          {url}
                        </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg max-h-64 overflow-y-auto">
                    <h5 className="font-semibold mb-2">Document Sample:</h5>
                    <pre className="text-sm text-gray-700 whitespace-pre-wrap">
                      {testDocuments.lowRisk.substring(0, 500)}...
                    </pre>
                  </div>
                </CardContent>
              </Card>
